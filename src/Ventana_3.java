...
public class Ventana_3 {
	...
	private void initialize() {
		...
		frmAadirProducto.setTitle("A\u00F1adir Producto");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (textField.getText().equals("") || textField_1.getText().equals("") || textField_2.getText().equals("")) {
					...
					conexion_1.A_Producto(Integer.parseInt(textField.getText()), textField_1.getText(), Integer.parseInt(textField_2.getText()), comboBox.getSelectedIndex()+1);				
